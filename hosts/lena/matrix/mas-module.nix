# Vendored from nixpkgs master, nixos/modules/services/matrix/matrix-authentication-service.nix
# at rev 425014edadcbf4993a59aaf7d6f3cd3867d83726. The module is not in nixpkgs 26.05 yet,
# only the package is. The upstream `meta` block was dropped (it references a team and a
# maintainer that 26.05 does not know). Delete this file once nixpkgs ships the module.
{
  config,
  lib,
  pkgs,
